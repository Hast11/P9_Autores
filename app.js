...
app.use(session({secret: "Blog 2023", //Cuidado con la 
                 resave: false,
...
app.use(function(req, res, next) {
  ...
  res.locals.loginUser = req.session.loginUser && {//Estamos guardando en req.locals.loginUser el req.session.loginUser
    //O en caso de estar definido, la variable de despues
    //El && dice que si existe lo de antes, lo de despues es el objeto que le tienes que asignar
